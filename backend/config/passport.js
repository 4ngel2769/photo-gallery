    ...
    new GoogleStrategy(
      {
        ...
        callbackURL: `${process.env.APP_URL_BACKEND || 'http://localhost:5000'}/api/auth/google/callback`,
      },
    ...
    new GitHubStrategy(
      {
        ...
        callbackURL: `${process.env.APP_URL_BACKEND || 'http://localhost:5000'}/api/auth/github/callback`,
        scope: ['user:email'],
      },
      async (accessToken, refreshToken, profile, done) => {
        try {
