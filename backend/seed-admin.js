...
const seedAdmin = async () => {
  try {
    ...
    const existingAdmin = await User.findOne({ email: 'root@admin.local' });
    ...
    if (existingAdmin) {
      ...
      // Create root admin user with default password
      const defaultPassword = process.env.ROOT_ADMIN_PASSWORD || 'admin123';
      ...
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.log('📧 Email:    root@admin.local');
